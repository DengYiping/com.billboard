...
import {mapStateToProps, mapDispatchToProps} from './leaserRegistration';
...
const WrappedOwnerRegistrationForm = Form.create()(OwnerRegistrationForm);
const connected =  connect(mapStateToProps, mapDispatchToProps)(WrappedOwnerRegistrationForm);
